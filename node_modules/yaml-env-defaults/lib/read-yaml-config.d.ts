 ...
 */
export declare const readYamlEnvSync: <T extends Record<string, any>>(filePath: string | string[], customEnv?: Record<string, any> | EnvVarResolver | undefined, options?: readYamlOptions | undefined, encoding?: string) => T;
/**
 ...
 */
export declare const readYamlEnv: <T extends Record<string, any>>(filePath: string | string[], customEnv?: Record<string, any> | EnvVarResolver | undefined, options?: readYamlOptions | undefined, encoding?: string) => Promise<T>;
