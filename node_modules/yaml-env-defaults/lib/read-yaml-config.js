...
function replaceEnvVarRefsWithDefaults(val, customEnv) {
    ...
    return foundValue.replace(/\${(\w+):(.+?)}/g, function (match, envVarName, defValue) {
 ...
 */
exports.readYamlEnvSync = function (filePath, customEnv, options, encoding) {
    if (encoding === void 0) { encoding = 'utf-8'; }
    var replacedYaml = {};
    if (Array.isArray(filePath)) {
        for (var _i = 0, filePath_1 = filePath; _i < filePath_1.length; _i++) {
            var file = filePath_1[_i];
            var yaml = js_yaml_1.load(fs_1.readFileSync(file, encoding), options === null || options === void 0 ? void 0 : options.jsYaml);
            if (yaml) {
        ...
        var yaml = js_yaml_1.load(fs_1.readFileSync(filePath, encoding));
        if (yaml) {
            replacedYaml = processYaml(replacedYaml, yaml, undefined, customEnv);
        }
    }
 ...
 */
exports.readYamlEnv = function (filePath, customEnv, options, encoding) {
    if (encoding === void 0) { encoding = 'utf-8'; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    file = filePath_2[_i];
                    return [4 /*yield*/, readFile(file, encoding)];
                case 2:
                    _file = _a.sent();
                    yaml = js_yaml_1.load(_file, options === null || options === void 0 ? void 0 : options.jsYaml);
                    if (yaml) {
                        replacedYaml = processYaml(replacedYaml, yaml, undefined, customEnv);
                    }
                    _a.label = 3;
                ...
                case 5: return [4 /*yield*/, readFile(filePath, encoding)];
                case 6:
                    _file = _a.sent();
                    yaml = js_yaml_1.load(_file, options === null || options === void 0 ? void 0 : options.jsYaml);
                    if (yaml) {
